...
class ServiceScraper:
    ...
    def get_services(self, service:str, location:str,ads_limit:int,social_links:list[str]) -> str:
...
with ServiceScraper(URL_MAPS) as scraper:
    print(scraper.get_services("peluqueria", "barquisimeto",6,["facebook","instagram"]))
